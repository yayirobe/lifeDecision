    ...
    <div class="page">
              ...
              <div class="rd-navbar-container">
                <div class="rd-navbar-logo">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#">Agenda</a></li>
      ...
      <section class="section-md">
        <div class="container">
          <div class="row row-30">
            <div class="col-12">
              <h2 class="text-uppercase">Our <span class="font-weight-light">services</span></h2>
            </div>
            <div class="col-md-6"><a class="panel" href="#">
                      <h4 class="panel-heading">Servicio 1</h4>
                      <div class="panel-icon fa-angle-right"></div></a><a class="panel" href="#">
                      <h4 class="panel-heading">Servicio 2</h4>
                      <div class="panel-icon fa-angle-right"></div></a><a class="panel" href="#">
                      <h4 class="panel-heading">Servicio 3</h4>
                      <div class="panel-icon fa-angle-right"></div></a><a class="panel" href="#">
